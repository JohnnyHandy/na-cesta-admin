...
import { Form, Label, ListGroup, ListGroupItem, Button, Input as Select } from 'reactstrap'
...
const RenderSelectInput = ({input, options, disabledOptions, ...props}) => {
    return (
        <Select
            size='sm'
            type='select'
...
const renderDetailsForm = ({ fields, index }) => {
...
const renderColorsForm = ({ fields, index }) => {
    const value = fields.getAll()
